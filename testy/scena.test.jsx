...
import { List, Czasteczki, Skrytka, MagicznyWybuch } from "../app/ui/ScenaKoperty";
...
it("mounts the actual R3F scene with React 19.3 and animates the flap", async () => {
  ...
  const scene = await create(<><Skrytka otwarta={false} /><List otwarta={false} przechyl={null} /><MagicznyWybuch otwarta={false} /><Czasteczki /></>);
  ...
  await scene.update(<><Skrytka otwarta /><List otwarta przechyl={{ x:.5, y:.2 }} /><MagicznyWybuch otwarta /><Czasteczki /></>);
